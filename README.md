NOTA INIZIALE:
Github non consente di salvare file più grandi di 100 MB, quindi non abbiamo potuto caricare le jdk.
...
L'alternativa di scaricarle all'avvio della macchina virtuale ci è sembrata troppo lenta e dipendente della qualità della connessione per fare la prova di esecuzione.
